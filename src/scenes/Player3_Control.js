export default function Player3_Control(scene,input){
    if(scene.state.current === scene.player3){
        if(scene.player3.state.isActive){
                ...
                if(scene.player3.state.isRun){
                    if(scene.player3.x < 480){
                        if(scene.player3.state.haveBall){
                            scene.state.current===scene.player1? scene.ball.x = scene.player3.x +30 : scene.ball.x = scene.player3.x+24;
            ...
            else if (scene.player3.state.haveBall && Phaser.Input.Keyboard.JustDown(scene.keys.z) && scene.player3.state.canThrow){
